...
var debug = __webpack_require__(147)("follow-redirects");
...
var _isNan = __webpack_require__(78);
  ...
  ****************************************************************/
  ...
  _buildResult: function _buildResult(res, options) {
    ...
    function RequestError(obj) {
      ...
      this.id = id || 'unknown';
      this.data = data;
      this.code = txn.res.status;
      this.headers = {};

      if (txn.res.headers['X-Usage-Limit-Info']) {
        this.headers['X-Usage-Limit-Info'] = txn.res.headers['X-Usage-Limit-Info'];
      }

      if (txn.res.headers['X-Usage-Limit-Time']) {
        this.headers['X-Usage-Limit-Time'] = txn.res.headers['X-Usage-Limit-Time'];
      }
    }
...
var url = __webpack_require__(73);
var zlib = __webpack_require__(154);
var pkg = __webpack_require__(155);
var createError = __webpack_require__(40);
var enhanceError = __webpack_require__(69);
...
var tty = __webpack_require__(151);
